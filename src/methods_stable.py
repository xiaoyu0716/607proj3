...
# Optimized: Use scipy's expit for better stability and speed
def _sigmoid(z: np.ndarray) -> np.ndarray:
    return expit(z)

# Optimized: Add fallback for singular matrices
...
# Optimized: Add fallback for singular matrices in IRLS
...
# --- The rest is identical to methods.py, but using the functions above ---
